...
def generate_launch_description():
    ...
    pkg__this = get_package_share_directory('m6e5_letsgoooooo')
    ...
    # Из этого же пакета запускаем скрипт для управления роботом
    movement_subpub = Node(
        package='m6e5_letsgoooooo',
        executable='movement_subpub',
        name='movement_subpub'
    )

    # Ну и собственно всё это исполняем, урааа!
